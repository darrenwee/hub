...
func (client *Client) FetchPullRequests(project *Project, filterParams map[string]interface{}, limit int, filter func(*Issue) bool) (pulls []Issue, err error) {
...
func (issue *Issue) IsSameRepo() bool {
	return issue.Head != nil && issue.Head.Repo != nil &&
		issue.Head.Repo.Name == issue.Base.Repo.Name &&
		issue.Head.Repo.Owner.Login == issue.Base.Repo.Owner.Login
}
